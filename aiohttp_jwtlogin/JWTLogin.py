...
class JWTLogin:
    ...
    def encode(self, payload: dict, lifetime=None) -> str:
        if not lifetime:
        ...
        return jwt.encode(payload,
                          self.JWT_SECRET_KEY,
                          algorithm=self.JWT_ENCODING_ALGORITHM).decode('utf-8')
    ...
    def bind(self, app: aiohttp.web.Application):
        """
        binding extension on the application
        :param app:
        """
        app['jwtlogin'] = self
